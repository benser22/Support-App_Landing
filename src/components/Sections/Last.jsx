...
function Last() {
  ...
  return (
    <div className="flex flex-col justify-center items-center py-12 pb-20 px-8 gap-2 bg-bg-secondary text-white">
      <p className="text-md sm:text-lg md:text-xl lg:text-2xl font-semibold self-start sm:self-center">
      ...
      <div className="flex flex-col sm:flex-row items-center mt-4 sm:mt-12 gap-2 w-full justify-center">
        <input
          ...
          className="w-[20rem] text-white bg-[#454457] p-3 px-2 border-none rounded-md border placeholder-[#DADADD]"
