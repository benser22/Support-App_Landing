                  ...
                  {item.items.map((option, index) => (
                    ...
                    >
                      <p
                        ...
                        className="truncate text-xs sm:text-[12px] xl:text-[14px] p-2 cursor-pointer hover:bg-opacity-70 hover:bg-secondary active:text-red-custom transition duration-300"
                        onClick={() => handleDropdownToggle(item.id)}
                      >
                        {option.text}
                      </p>
